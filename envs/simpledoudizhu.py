...
class SimpleDoudizhuEnv(Env):
    ...
    def __init__(self, config):
        from games.simpledoudizhu import game
        from games.simpledoudizhu.utils import encode_cards
        from games.simpledoudizhu.utils import cards2str
        from games.simpledoudizhu.utils import SPECIFIC_MAP, CARD_RANK_STR
        from games.simpledoudizhu.utils_s import ACTION_LIST, ACTION_SPACE
        ...
        self.game = game.SimpleDoudizhuGame()
