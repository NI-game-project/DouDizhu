...
from games.simpledoudizhu.dealer import SimpleDoudizhuDealer
from games.simpledoudizhu.utils import cards2str, doudizhu_sort_card
from games.simpledoudizhu.utils import CARD_RANK_STR, CARD_RANK_STR_INDEX
...
class SimpleDoudizhuRound(object):
    ...
    def __init__(self, np_random):
        ...
        self.dealer = SimpleDoudizhuDealer(self.np_random)
