...
class DoudizhuEnv(Env):
    ...
    def __init__(self, config):
        from doudizhu_game.utils import SPECIFIC_MAP, CARD_RANK_STR
        from doudizhu_game.utils import ACTION_LIST, ACTION_SPACE
        from doudizhu_game.utils import encode_cards
        from doudizhu_game.utils import cards2str, cards2str_with_suit
        from doudizhu_game import game
