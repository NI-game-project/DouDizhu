...
class SimpleDoudizhuEnv(Env):
    ...
    def __init__(self, config):
        from simpledoudizhu_game import game
        from simpledoudizhu_game.utils import encode_cards
        from simpledoudizhu_game.utils import cards2str
        from simpledoudizhu_game.utils import SPECIFIC_MAP, CARD_RANK_STR
        from simpledoudizhu_game.utils_s import ACTION_LIST, ACTION_SPACE
